        ...
        <div className="flex justify-center items-center">
          ...
          <span onClick={handleUserDropdown} className="flex justify-center items-center gap-2 cursor-pointer">
            ...
            <div className="relative border-none bg-transparent select-none bg-gray-900 rounded-[48px] text-base font-light font-['Inter'] leading-7">UserName
              ...
              <div className="absolute hidden mt-1 bg-[#0A2647] p-1 right-[-20px] w-[7rem] rounded z-20 gap-1" id="userDropdown"><ul>
              <li className="border-b-[.1rem] p-1 hover:bg-[#07192f] transition-all duration-200">Profile</li>
              <li className="border-b-[.1rem] p-1 hover:bg-[#07192f] transition-all duration-200">Subscribe</li>
              <li className=" p-1 hover:bg-[#07192f] transition-all duration-200">Sign Out</li>
